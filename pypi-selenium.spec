...
%prep
%setup -q -n selenium-4.22.0
cd %{_builddir}/selenium-4.22.0
pushd ..
cp -a selenium-4.22.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718985820
...
rm -f %{buildroot}*/usr/lib/python3.12/site-packages/selenium/webdriver/common/windows/selenium-manager.exe
