...
Version  : 4.20.0
Release  : 104
URL      : https://files.pythonhosted.org/packages/32/d1/6c27d3ec3b91d8c7804a4298538024eb7919551e97cca6eecb26c83ae9fa/selenium-4.20.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/32/d1/6c27d3ec3b91d8c7804a4298538024eb7919551e97cca6eecb26c83ae9fa/selenium-4.20.0.tar.gz
...
%prep
%setup -q -n selenium-4.20.0
cd %{_builddir}/selenium-4.20.0
pushd ..
cp -a selenium-4.20.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714060762
