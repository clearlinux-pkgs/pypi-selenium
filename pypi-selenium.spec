...
Version  : 4.8.2
Release  : 82
URL      : https://files.pythonhosted.org/packages/92/1e/e25dee0e94cdab007464279ee599e4663a4cc3e829bb3448a4084fca4b79/selenium-4.8.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/92/1e/e25dee0e94cdab007464279ee599e4663a4cc3e829bb3448a4084fca4b79/selenium-4.8.2.tar.gz
...
%prep
%setup -q -n selenium-4.8.2
cd %{_builddir}/selenium-4.8.2
pushd ..
cp -a selenium-4.8.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676770796
