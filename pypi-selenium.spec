...
Source0  : https://files.pythonhosted.org/packages/2e/3d/492cf1a6823c48369328572c6bc63b7a957ba25c0009ee6bdb507cd9a6a4/selenium-4.8.0.tar.gz
...
%prep
%setup -q -n selenium-4.8.0
cd %{_builddir}/selenium-4.8.0
pushd ..
cp -a selenium-4.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674495518
