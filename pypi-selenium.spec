...
Source0  : https://files.pythonhosted.org/packages/df/cc/d6caa96d89c4a81a0603080a8ea95c952be32076a7d54f4a82d9ff5f4480/selenium-4.21.0.tar.gz
...
%prep
%setup -q -n selenium-4.21.0
cd %{_builddir}/selenium-4.21.0
pushd ..
cp -a selenium-4.21.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715874144
